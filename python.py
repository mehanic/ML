...
print(f"\nSRT-файл от Wav2Vec2 сохранён: {srt_path}")

# --- Whisper распознавание с точными таймингами ---

print("\nЗапускаем Whisper для получения субтитров с таймингами...")

# Указываем device здесь при загрузке модели
whisper_model = whisper.load_model("base", device="cpu")
result = whisper_model.transcribe(mp3_path, word_timestamps=True)  # без device
...
print(f"\nSRT-файл с таймингами от Whisper сохранён: {whisper_srt_path}")
